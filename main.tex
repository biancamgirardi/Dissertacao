...
%
%
\documentclass[mestrado,estrutura,pt]{ppgec}
%	
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
\include{./chap/cap2}		% Capítulo 2: Problemática geral de túneis
\include{./chap/cap3}		% Capítulo 3: Modelos constitutivos
\include{./chap/cap4}		% Capítulo 4: Verificações preliminares
\include{./chap/cap5}
\include{./chap/cap6}		% Capítulo 6:
\include{./chap/cap7}		% Capítulo 7: 
\include{./chap/cap8}		% Capítulo 8: 
\include{./chap/cap9}		% Capítulo 8: 
...
% Comente oo comando abaixo para remover páginas com símbolos em latex%\imprimiranexopdf{./pos/latex_symbols}{Símbolos matemáticos}{1}{2-}
%
%
\end{document}
