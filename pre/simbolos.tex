...
\item[$U_eq$]							Convergência de equilíbrio de um túnel revestido
\item[$U_i$]							Convergência em r = $R_i$
\item[$u_r$]							?
\item[$U_0$]							Convergência da seção do túnel na cota não revestida a partir da face de
escavação
%Símbolos gregos:
\item[$ \gamma_m$]						Peso específico do maciço
\item[$ \sigma_v$]						Tensão vertical
\item[$ \sigma_{\theta}$]				Componente de tensão
\item[$ \sigma_r$]						Componente de tensão radial
