...
O objetivo principal do trabalho consiste em analisar a redistribuição de esforços no revestimento devido à escavação de uma galeria transversal em túneis gêmeos profundos considerando modelos constitutivos não-lineares e dependentes do tempo para o maciço e o revestimento.

Para alcançá-lo, foram definidos objetivos específicos:

\begin{alineas}
	
	\item investigar o efeito do parâmetro friccional (ângulo de atrito);
