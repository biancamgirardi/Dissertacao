...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=0.44]{desmoronamentoSPPB.jpg}
	\end{center}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=0.5]{desmoronamentoheathrowPB.png}
	\end{center}
...
\begin{alineas}
	...
	\item implementar a superfície de Mohr-Coulomb na subrotina constitutiva elastoplástica-viscoplástica desenvolvida por \citeonline{Quevedo2017} e \citeonline{Quevedo2021};
	
	\item realizar análises paramétricas na problemática de túneis gêmeos com o modelo elastoplástico-viscoplástico.
