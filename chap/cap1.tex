...
O objetivo principal do trabalho consiste na análise de túneis gêmeos profundos interligados galerias transversais considerando modelos constitutivos não-lineares e dependentes do tempo para o maciço e o revestimento.

Para alcançá-lo, foram definidos objetivos específicos:

\begin{alineas}
	
	\item analisar a influência da escavação da galeria na redistribuição das tensões e nos perfis de convergência; 
	
	\item investigar o efeito do parâmetro friccional (ângulo de atrito) nos perfis de convergência dos túneis longitudinais;
