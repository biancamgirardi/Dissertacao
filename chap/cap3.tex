...
A abertura de um túnel em um maciço em equilíbrio, submetido a um estado inicial de tensões, pode ser vista como a remoção das tensões presentes no entorno da escavação. Essa retirada resulta em um rearranjo das tensões dentro do maciço, que irá procurar atingir um novo estado de equilíbrio (Rocha 1971 apud França, 2006). Este novo estado de tensões pode ser alcançado sem a implementação de um sistema de suporte auxiliar, caracterizando o maciço como autoportante, ou com a utilização de um sistema de suporte para ajudar a conter as deformações do maciço.

Segundo Langer e Stockman (1985), durante a escavação do túnel, as deformações permitidas ao maciço resultam em redistribuições de tensões para zonas do entorno não escavadas.Essa redistribuição ocorre no formato de um arco nas direções longitudinal e transversal do revestimento, sendo o efeito denominado arqueamento de tensões. O carregamento que atua no revestimento e os deslocamentos que nele ocorrem são interdependentes e correlacionados, não dependendo apenas das tensões iniciais e das características geométricas da abertura do túnel, mas também das propriedades mecânicas do maciço no entorno do túnel e do processo construtivo adotado, incluindo o sistema de escavação, velocidade de avanço e as características do sistema de suporte empregado (SOUZA, 1998 apud França, 2006).
