...
Este trabalho teve como objetivo principal investigar a influência de galerias transversais nas deformações em túneis gêmeos profundos, através de um modelo computacional considerando diferentes modelos de comportamento do revestimento e ângulos de atrito para o maciço. A partir dessa abordagem, foi possível investigar a distribuição de tensões, o comportamento das deformações e a interação entre os túneis em cenários com e sem a presença de uma galeria transversal.
