...
Após o reconhecimento internacional do Novo Método Austríaco de Túneis, também conhecido como NATM (\textit{New Austrian Tunneling Method}), profissionais da área de túneis passaram a discutir se o método consiste em uma técnica ou uma filosofia. De acordo com o professor L. V. Rabcewicz, um dos principais desenvolvedores do NATM, o método consiste na aplicação de uma fina camada de concreto projetado que deve ser rapidamente fechado por um arco auxiliar, cuja deformação é monitorada até que o equilíbrio seja alcançado (KARAKUS E FOWELL, 2004). 
