...
% ----------------------------------------------------------
O constante aumento da população mundial está diretamente relacionado ao crescimento das obras subterrâneas, visto que a superfície é cada vez mais valorizada para habitação e lazer, enquanto outras infraestruturas, como a de transporte ou saneamento básico, por exemplo, são relegadas para o subsolo.
...
A tensão vertical ($\sigma_v$) pode ser calculada pela \autoref{equacao}, e é dependente da profundidade e do peso específico do maciço ($\gamma_m$):
