...
"O método de convergência-confinamento (CV-CF), descrito nas publicações da AFTES (1979-1983), é um método aproximado para calcular túneis, que leva em conta a interação entre as duas estruturas, mas propõe uma dissociação que permite que todo o estudo seja reduzido a um estudo de deformação plana." (bernaud, rousset, 1992)
