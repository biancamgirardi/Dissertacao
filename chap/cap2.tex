...
O método convergência-confinamento (CV-CF) é considerado um método simplificado para o cálculo de túneis por se tratar de um problema bidimensional ou unidimensional. Consiste em desacoplar o problema da interação entre maciço e revestimento na face de escavação através dos conceitos de curva de confinamento e curva de convergência (AFTES, 2001). 
