...
Assim como os demais métodos simplificados presentes neste trabalho, a principal ferramenta de análise do NATM são as curvas características que representam a interação maciço-revestimento, como demonstra a \autoref{curvasNATM}.
...
\begin{figure}[H]
	...
	\end{center}
	\caption{\label{curvasNATM} Curvas interação maciço-revestimento (fonte: Karakus e Fowell (2004) (fazer a citaçao))}
\end{figure}
