...
O método convergência-confinamento (CV-CF), também conhecido como método das curvas características, trata de uma abordagem aproximada para o cálculo de túneis considerando um problema bidimensional de deformação plana da interação maciço e revestimento. Esse método consiste em desacoplar o problema através dos conceitos de curva de confinamento do revestimento e curva de convergência do maciço (AFTES, 2001). 
