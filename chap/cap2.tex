...
% ---
\section{Métodos de dimensionamento de suporte}
% ---
...
O método convergência-confinamento (CV-CF) é considerado um método aproximado para o cálculo de túneis, abordando um problema bidimensional de deformação plana da interação maciço e revestimento, e consiste em desacoplar esse problema através dos conceitos de curva de confinamento do revestimento e curva de convergência do maciço (AFTES, 2001). 

A convergência na seção de um túnel é definida como o deslocamento relativo entre dois pontos em faces opostas ao longo de uma direção específica, como demonstrado na figura X. É considerada positiva se esses pontos tendem a se aproximar e negativa ao se afastarem (PANET, 1995).
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=0.6]{tunelrasoeprofundo.pdf}
	\end{center}
	\caption{\label{tunelrasoeprofundo} Distinção entre túnel raso e profundo (fonte: adaptado de Benamar (fazer a citaçao))}
\end{figure}
