...
# Ler arquivo txt e guarda em um array
file_path = 'MA_EP_MC_SR_NOVO/stressx_zf_45.txt'
data_array = np.loadtxt(file_path)
...
# Ler arquivo txt e guarda em um array
file_path = 'MA_EP_MC_SR_NOVO/stressy_zf_45.txt'
data_array = np.loadtxt(file_path)
...
# Ler arquivo txt e guarda em um array
file_path = 'MA_EP_MC_SR_NOVO/stressx_zf_90.txt'
data_array = np.loadtxt(file_path)
...
# Ler arquivo txt e guarda em um array
file_path = 'MA_EP_MC_SR_NOVO/stressy_zf_90.txt'
data_array = np.loadtxt(file_path)
...
# Ler arquivo txt e guarda em um array
file_path = 'MA_EP_MC_SR_NOVO/stressx_zf_135.txt'
data_array = np.loadtxt(file_path)
...
# Ler arquivo txt e guarda em um array
file_path = 'MA_EP_MC_SR_NOVO/stressy_zf_135.txt'
data_array = np.loadtxt(file_path)
