...
#%% PERFIL DE CONVERGENCIAS - EPVP_VEL_D1_4RT_DPII
""" ********************************************
PERFIL DE CONVERGENCIAS - EPVP_VEL_D1_4RT_DPII
******************************************** """ 
...
figura      = 1
titulo      = 'Perfil de convergências - EPVP_VEL_$d_1=4R_t$_DPII'
lbleixox    = r'$z/R_t$'
lbleixoy    = r'$U_B$ [\%]'
xmin        = 5 
xmax        = 40
